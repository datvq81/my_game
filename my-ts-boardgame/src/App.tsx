    ...
    <div style={{ width: '100vw', height: '100vh', position: 'relative', backgroundColor: '#1a1a1a' }}>
      ...
      {appState === 'lobby' && (
        <div style={{ display: 'flex', width: '100%', height: '100%' }}>
          ...
          >
            <h2 style={{ color: '#ffd700', margin: '0 0 10px 0', textAlign: 'center', fontSize: '28px' }}>
              ⚔️ HEX CONQUEST
            </h2>
            ...
            {lobbyMode === 'host' ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                <p style={{ color: '#aaa', fontSize: '14px', margin: 0 }}>
                  Bạn là <strong>Chủ phòng (Player 1)</strong>. Hãy cài đặt thông số và chọn Bản đồ ở màn hình bên phải để bắt
                  đầu.
                </p>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                ...
                <label style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                  ...
                  <select
                    ...
                    style={{ padding: '8px', background: '#333', color: 'white', border: '1px solid #777', borderRadius: '4px' }}
                  >
